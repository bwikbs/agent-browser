...
Options:
  ...
  --engine <name>            Browser engine: chrome (default), lightpanda, starfish (or AGENT_BROWSER_ENGINE)
...
Environment:
  ...
  AGENT_BROWSER_ENGINE           Browser engine: chrome (default), lightpanda, starfish
  STARFISH_BIN                   Path to the Starfish binary (for --engine starfish)
